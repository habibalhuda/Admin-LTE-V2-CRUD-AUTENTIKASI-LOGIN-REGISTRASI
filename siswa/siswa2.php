                              ...
                              <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                          ...
                                          <tbody>
                                                <?php
include "koneksi.php";
$hasil=mysqli_query($mysqli,"select * from tabel_siswa");
$no=1;
...
?>
                                                <tr>
                                                      ...
                                                      <td><?php if($row['jenis_kelamin']=='L'){ echo "Laki-laki";} else{ echo "Perempuan";}?>
                                                      </td>
                                                      <td><?php echo $row['agama']?></td>
                                                      <td><a href="index.php?hal=edit_siswa&nis=<?php echo $row['nis']?>"><button
                                                                        type="button" class="btn btn-warning" name="">
                                                                        <i class="fa fa-pencil"></i> Edit</button></a>
                                                            <a onclick="return confirm('Anda Yakin...?')"
                                                                  href="siswa/hapus_siswa.php?nis=<?php echo $row['nis']?>">
